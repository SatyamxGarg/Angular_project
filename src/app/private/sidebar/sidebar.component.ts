...
// project import
import { NavigationItem, NavigationItems } from '../../privates/layouts/admin-layout/navigation/navigation';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule,NgScrollbar,CardComponent,IconModule],
